...
- 기타 : OpenCV 3.4.5 (영상 파일 읽고 화면 출력하기 위한 용도, docker 이용 시 설치되어 0있으면 안해도 됨) 
  설치 & 빌드 스크립트) wget https://soynet.io/demo/opencv_345_install_jetsonNano.sh && bash ./buildOpenCV.sh
